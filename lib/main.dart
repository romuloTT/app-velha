    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          // Alteração para a escala 4:3
          Container(
            width: 240, // A largura foi ajustada
            height: 180, // A altura foi ajustada
            child: GridView.builder(
              shrinkWrap: true,
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: 3,
                childAspectRatio: 4 / 3, // Agora a proporção é 4:3
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        board[index],
                        style: TextStyle(
                          fontSize: 20, // Ajuste no tamanho da fonte para ficar proporcional
